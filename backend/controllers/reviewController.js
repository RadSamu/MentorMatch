...
exports.createReview = async (req, res) => {
  ...
  try {
    ...
    if (new Date(bookingResult.rows[0].start_ts) > new Date()) {
      return res.status(400).json({ msg: 'Non puoi recensire una sessione non ancora avvenuta.' });
    }
